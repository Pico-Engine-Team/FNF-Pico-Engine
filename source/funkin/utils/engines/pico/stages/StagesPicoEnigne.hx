...
import funkin.stages.data.weekspecial.engine.standard.*;
import funkin.stages.data.weekspecial.engine.mods.*;
import funkin.stages.data.weekspecial.engine.retake.*;
import funkin.stages.data.weekspecial.engine.mods.exe.*;
import funkin.stages.data.weekspecial.engine.mods.exe.encore.*;
import funkin.stages.data.weekspecial.engine.mods.funkadelix.*;
